			                ...
			                forEach(data.records, function (record) {
			                	...
			                	forEach(record.fields,function(field,fieldkey){
				        			if(field.type == "REFERENCE") {
				        				...
				        				if(model[fieldkey]) {
				        					// field.value = 
					        				var getsub = model[fieldkey].$get({records:{recordName:field.value.recordName}})
				        				...
				        				if(model[fieldkey]) {
				        					...
				        					forEach(values,function(referencevalue){
				        						var getsub = model[fieldkey].$get({records:{recordName:referencevalue.recordName}})
						        				getsub.then(function(subres){
						        					// console.log(subres.record.fields,fieldkey);
